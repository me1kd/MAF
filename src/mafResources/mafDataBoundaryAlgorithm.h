...
public:
    ...
    virtual mafCore::mafProxyInterface *calculateBoundary(mafCore::mafProxyInterface *data, mafMatrix4x4 *matrix = NULL) = 0;
...
protected:
    ...
    virtual mafCore::mafProxyInterface *calculateBoundary(double bounds[6], mafMatrix4x4 *matrix = NULL) = 0;
